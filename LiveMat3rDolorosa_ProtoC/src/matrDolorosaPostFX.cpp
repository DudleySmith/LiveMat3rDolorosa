...
void matrDolorosaPostFX::setup(){
    ...
    panel.add(dofAltPassEnable.set("dofAltPassEnable", true));
    ...
    panel.add(dofAltShowFocus.set("dofAltShowFocus", true));
    
    //RGBShiftPass(const ofVec2f& aspect, bool arb, float amount = 0.005, float angle = 0.0);
    panel.add(rgbShiftEnable.set("rgbShiftEnable", true));
    ...
    panel.add(zoomBlurEnable.set("zoomBlurEnable", true));
