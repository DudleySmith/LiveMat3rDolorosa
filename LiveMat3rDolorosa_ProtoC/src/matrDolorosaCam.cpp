...
void matrDolorosaCam::setup(){
    ...
    fov.addListener(this, &matrDolorosaCam::fovChanged);
...
// -------------------------------------------
void matrDolorosaCam::fovChanged(float & fovChange){
    setFov(fovChange);
}
...
// -------------------------------------------------
void matrDolorosaCam::recordCam(){
